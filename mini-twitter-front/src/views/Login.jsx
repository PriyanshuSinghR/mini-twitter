    ...
    <div className="w-full h-screen flex items-center justify-center">
      {next ? (
        <div className="w-[300px] flex flex-col items-center justify-center gap-6">
          ...
          <span className="text-3xl font-bold">Enter Password</span>
          ...
          <input
            autoFocus
            onKeyUp={(e) => (e.key == 'Enter' ? auth() : false)}
          ...
          <button onClick={auth} className="w-full h-10 flex font-bold items-center justify-center gap-4 bg-white text-black rounded-3xl transition-all hover:bg-[#E6E6E6] ">
            {loading ? <div className="w-4 h-4 border-gray-600 border-2 border-t-[#1d9bf0] rounded-full animate-spin "></div> : <span>LogIn</span>}
          </button>
        </div>
      ) : (
        <div className="w-[300px] flex flex-col items-center justify-center gap-6">
          <img src={Logo} width="30" alt="" />
          <span className="text-3xl font-bold">Mini Twitter</span>
          ...
          <input
            onKeyUp={(e) => (e.key == 'Enter' ? setNext(true) : false)}
          ...
          <p className="text-left w-[100%]">
            ...
            <Link to="/register" className="text-[#1d9bf0]">
              Sign up
            </Link>
          </p>
        </div>
